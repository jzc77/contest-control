...
function TableOfLinks({ reminderInfo, listOfLinks, listOfButtonInfo, isSubmitClicked }) {
  // {reminderInfo.link}
  ...
  for (var i = 0; i < reminderInfo.length; i++) {
    var tempObj = {}
  ...
  // console.log("this is finalArrayOfObjects2:");
  // console.log(finalArrayOfObjects2);
  // console.log("this is reminderInfo: ", reminderInfo);
  ...
  const {
    ...
    rows,
    prepareRow,
  } = useTable(isSubmitClicked == true ? { columns: columns1, data: [reminderInfo.link] } : { columns: columns1, data: [reminderInfo.link] })
